...
decoding_method ("Choose greedy or sample") = st.sidebar.text_input("Decoding method", type="default")
repetition_penalty ("Choose either 1 or 2") = st.sidebar.text_input("Repetition penalty", type="default")
temperature ("Choose values between 0 & 2") = st.sidebar.text_input("Temperature", type="default")
